...
<FlexBasedImageContainer childrenProps={[
	...
	{ src: conwayImage, alt: "Conway's Game of Life" },
	{ src: complexDiagramImage, alt: "Story diagram in evergreen.ink" },
]} />
...
<FlexBasedImageContainer childrenProps={[
	{ src: brokerBayScreenshot1, alt: "Screenshot of BrokerBay app on the home screen" },
	{ src: brokerBayScreenshot2, alt: "Screenshot of BrokerBay app with loading skeletons" },
	{ src: brokerBayScreenshot3, alt: "Screenshot of BrokerBay app on the listing screen" },
]} />
...
<FlexBasedImageContainer childrenProps={[
	{ src: cubeImage, alt: "A cube in mixed reality" },
	{ src: prototypeImage, alt: "Early physical prototype" },
]} />
...
<FlexBasedImageContainer childrenProps={[
	...
	{ src: twentySeventhLetterImage, alt: "Twenty Seventh Letter graphic" },
