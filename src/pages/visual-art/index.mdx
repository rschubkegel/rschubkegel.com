...
<Image src={kulshanMountainImage} alt="Kulshan Mountain painting" style={{ marginBottom: 'var(--spacing)' }} />

<FlexBasedImageContainer childrenProps={[
	{ src: orangesImage, alt: "Oranges painting" },
	{ src: frenchPressImage, alt: "French Press painting" },
]} />
...
<ProjectHeader>
	## [Typography Class](/visual-art/typography-class)
</ProjectHeader>
...
<ProjectHeader>
	## [Creative Suite Class](/visual-art/creative-suite-class)
</ProjectHeader>
...
<ProjectHeader>
	## [Animations](/visual-art/animation)
</ProjectHeader>

I love bringing drawings to life through animation. Some of my favorite animations are compiled here for you enjoyment!

<FlexBasedImageContainer childrenProps={[
	{ src: walkImage, alt: "Hand-drawn walk cycle" },
	{ src: firePaperImage, alt: "Fire animation made from cut construction paper" },
	{ src: montyPythonImage, alt: "2D digital animation of angry green character with wavy eyebrows quoting Monty Python" },
]} />