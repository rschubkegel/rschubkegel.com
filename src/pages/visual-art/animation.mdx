...
<FlexBasedImageContainer childrenProps={[
	...
	{ src: zoetropeImage, alt: "Zoetrope animation of a paper airplane falling" },
	{ src: circleBoogieImage, alt: "Digital 2D animation of circle being cut to reveal Edward Scissorhands, then spiders crawl into his face and he morphs into the Jason mask, then the mask tilts to reveal Pennywise, then a red balloon lifts and transforms into the circle from the beginning" },
]} />
...
<FlexBasedImageContainer childrenProps={[
	{ src: sixFeetApartImage, alt: "Animation made with common household objects of two characters approaching, looking down at six feet caption, and stepping back" },
	{ src: jackInTheBoxImage, alt: "Digital 2D animation of character walking through play room, being scared by a jack-in-the-box, and tripping on a banana peel" },
]} />
...
<FlexBasedImageContainer childrenProps={[
	...
	{ src: explosionImage, alt: "Digital 2D animation of bottle exploding" },
	{ src: digitalFireImage, alt: "Digital 2D animation of flickering fire" },
]} />

If you want to see my most recent animations, check out my [game dev projects](/games).

<FlexBasedImageContainer childrenProps={[
	{ src: bunnyImage, alt: "2D digital animation of bunny hopping, eating grass, and being surprised by the gopher who's hair it was eating" },
	{ src: montyPythonImage, alt: "2D digital animation of angry green character with wavy eyebrows quoting Monty Python" },
	{ src: waveImage, alt: "2D digital animation of stick person walking by, doing a double-take, and waving" },
]} />