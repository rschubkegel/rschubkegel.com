...
<FlexBasedImageContainer childrenProps={[
	{ src: adminLoginImage, alt: "Admin login page" },
	{ src: adminHeaderImage, alt: "Admin header component" },
	{ src: adminEmployeesImage, alt: "Admin employees page" },
	{ src: adminLogosImage, alt: "Admin logos page" },
]} />