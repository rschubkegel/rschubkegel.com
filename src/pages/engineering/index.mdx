...
<Image src={cubeImage} alt="A cube in mixed reality" />

<FlexBasedImageContainer childrenProps={[
	{ src: userFlowImage, alt: "User flow diagram" },
	{ src: wireframesImage, alt: "Wireframe of user interface" },
]} />
...
<FlexBasedImageContainer childrenProps={[
	...
	{ src: detectionImage, alt: "Objects detected with computer vision" },
]} />